...
/**
 * unit test for {@link Algorithms#djkistra(Graph, com.melimelo.graphs.Vertex)}
 */
@SuppressWarnings("serial")
public class DjkistraTests extends ShortestPathsTestBase {

    @Test(expected = IllegalArgumentException.class)
    public void testDjkistraOnNullGraph() throws Exception {
        Algorithms.djkistra(GraphFactory.createNullGraph(), SOURCE_VERTEX);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testDjkistraWithNullSourceVertex() throws Exception {
        Algorithms.djkistra(GraphFactory.createEmptyGraph(), null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testDjkistraOnEmptyGraph() throws Exception {
        Algorithms.djkistra(GraphFactory.createEmptyGraph(), SOURCE_VERTEX);
    }

    @Test
    public void testDjkistraOnSingletonGraph() throws Exception {
        Graph graph = GraphFactory.createSingletonGraph();
        List<Path> paths = Algorithms.djkistra(graph, SOURCE_VERTEX);
        assertTrue(paths.isEmpty());
    }

    @Test
    public void testDjkistraOnUnDirectedWeightedCyclicGraph() throws Exception {
        Graph graph = GraphFactory.createUnDirectedWeightedCyclicGraph();
        List<Path> shortestPaths = Algorithms.djkistra(graph, SOURCE_VERTEX);
    ...
    @Test
    public void testDjkistraOnUnDirectedUnWeightedCyclicGraph()
            throws Exception {
    ...
    @Test
    public void testDjkistraOnUnDirectedWeightedAcyclicGraph()
            throws Exception {
    ...
    @Test
    public void testDjkistraOnUnDirectedUnWeightedAcyclicGraph()
            throws Exception {
    ...
    @Test
    public void testDjkistraOnDirectedWeightedCyclicGraph() throws Exception {
    ...
    @Test
    public void testDjkistraOnDirectedUnWeightedCyclicGraph() throws Exception {
    ...
    @Test
    public void testDjkistraOnDirectedWeightedAcyclicGraph() throws Exception {
    ...
    @Test
    public void testDjkistraOnDirectedUnWeightedAcyclicGraph()
            throws Exception {

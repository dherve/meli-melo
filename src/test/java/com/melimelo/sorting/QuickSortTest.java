...
import com.melimelo.sorting.QuickSort;
...
public class QuickSortTest {
    ...
    public void testSort() {
        ...
        QuickSort.sort(m_testValues);
        assertArrayEquals(m_sortedValues, m_testValues);
    }

    @Test
    public void testSortUsingHoarePartitionAlgorithm() {
        ArraysUtils.shuffle(m_testValues);
        QuickSort.sort(m_testValues, QuickSort.PartitionAlgorithm.HOARE);
        assertArrayEquals(m_sortedValues, m_testValues);
    }

    @Test
    public void testSortUsingLomutoPartitionAlgorithm() {
        ArraysUtils.shuffle(m_testValues);
        QuickSort.sort(m_testValues, QuickSort.PartitionAlgorithm.LOMUTO);
        assertArrayEquals(m_sortedValues, m_testValues);
    }
    ...
    @Test
    public void testSortBigArrayUsingHoarePartitionAlgorithm() {
        m_sortedValues= new Integer[MAX_SIZE_ARRAY];
        for(int index = 0; index < MAX_SIZE_ARRAY; index++) {
            m_sortedValues[index] = index;
        }
    ...
    @Test
    public void testSortBigArrayUsingLomutoPartitionAlgorithm() {
